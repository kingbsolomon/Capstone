...
class MyResults extends StatefulWidget {
  MyResults({Key key, this.title}): super(key:key);
  final String title;
  @override
...
class _MyResultsState extends State<MyResults> {
  ...
  List<CircularStackEntry> circularData = <CircularStackEntry>[
    new CircularStackEntry(
      ...
      rankKey: 'Poll Vote Distribution',
    ),
  ];
        ...
        child:StaggeredGridView.count(
          ...
          children: <Widget>[
            Padding(
              ...
              child: mychart1Items("Votes by Month","Polls","Estimated % Growth"),
            ),
            Padding(
              padding: const EdgeInsets.all(5.0),
              child: myCircularItems("Total Votes By:","Poll"),
            ),
            Padding(
            ...
            Padding(
              padding: const EdgeInsets.only(right:8.0),
              child: myTextItems("Total Votes","$totalVotes"),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: mychart2Items("Revenue By Month","In Dollars","+200% Growth August"),
            ),
